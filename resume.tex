...
Skilled programmer with experience in full-stack development, AWS, machine learning, and scientific computing
\\

\textbf{Key Skills:} JavaScript \vbar TypeScript \vbar Python \vbar AWS \vbar React \vbar React-Native \vbar ESLint \vbar Agile
...
\textbf{Trello PowerUp - "Pomorello"}
\begin{itemize}
  \item Authored a web application integrated within Trello for time management, with over 1000 users
  \item Developed continuous deployment with CircleCI and github pages to automatically deploy changes after peer review with trello engineers \\
\end{itemize}
